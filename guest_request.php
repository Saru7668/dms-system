        ...
        if ($check_out_date < $check_in_date || ($check_out_date === $check_in_date && $check_out_time <= $check_in_time)) {
            ...
            try {
                ...
                if ($action === 'submit') {
                            ...
                            <html><body style='font-family:Segoe UI,sans-serif;color:#333;'>
                                <div style='max-width:600px;margin:20px auto;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;'>
                                    <div style='background:#1a2a3a;color:#fff;padding:20px;text-align:center;'>
                                        ...
                                        <p style='margin:5px 0 0;'>Reference ID: #$req_id</p>
                                    </div>
                                    <div style='padding:25px;'>
                                        <p>Dear <strong>{$g['name']}</strong>,</p>
                                        ...
                                        <div style='background:#f8f9fa;border-left:4px solid #1a2a3a;padding:15px;margin:20px 0;'>
                                            <p style='margin:0;'><strong>Check-in:</strong> " . date('d M Y', strtotime($check_in_date)) . " at " . date('h:i A', strtotime($check_in_time)) . "</p>
                                            <p style='margin:5px 0;'><strong>Check-out:</strong> " . date('d M Y', strtotime($check_out_date)) . " at " . date('h:i A', strtotime($check_out_time)) . "</p>
                    ...
                    // 2. MAIL TO ADMIN / AUTHORIZATION TEAM (USING user_role COLUMN)
                    $admin_subject = "New Request #$req_id Waiting for Approval";
                    $admin_emails = [];

                    // ✅ DYNAMIC ADMIN FETCH FROM DATABASE USING CORRECT COLUMN `user_role`
                    ...
                    <html><body style='font-family: Arial, sans-serif; color: #333; line-height: 1.6;'>
                        <p>SCL DORMITORY SYSTEM - NOTIFICATION<br>
                        =====================================================</p>
                        <p>Dear Authorization Team,</p>
                        <p>A new visit request has been submitted and requires your attention.</p>
                        
                        <p><strong>REQUEST DETAILS</strong><br>
                        Guest Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $first_guest_full<br>
                        Requested By &nbsp;&nbsp;&nbsp;&nbsp;: $user<br>
                        Check-in &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $admin_check_in<br>
                        Planned Check-out : $admin_check_out<br>
                        -----------------------------------------------------</p>
                        
                        <p>Please log in to approve: <a href='http://192.168.6.113/dormitory/manage_requests.php'>http://192.168.6.113/dormitory/manage_requests.php</a></p>
                        
                        <p>SCL Dormitory Management System</p>
                    </body></html>";
            ...
            <div class="col-md-11">
                <div class="card shadow-sm border-0">
                    <div class="card-header <?php echo $edit_id > 0 ? 'bg-warning text-dark' : 'bg-dark text-white'; ?> d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <?php if ($edit_id > 0): ?>
                                <i class="fas fa-pencil-alt me-2"></i>Edit Draft Request (Ref: #<?php echo $edit_id; ?>)
                            <?php else: ?>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="guest_request.php" id="requestForm">
                            ...
                            <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-add" onclick="addGuest()"><i class="fas fa-user-plus me-1"></i> Add Another Guest</button>
                            </div>
                                    ...
                                    <?php foreach ($draft_guests as $index => $g): ?>
                                        <div class="guest-card" id="row_<?php echo $index; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 mb-3"><label class="form-label">Name *</label><input type="text" name="guest_name[]" class="form-control <?php echo $index == 0 ? 'readonly-field' : ''; ?>" value="<?php echo htmlspecialchars($g['guest_name']); ?>" <?php echo $index == 0 ? 'readonly' : 'required'; ?>></div>
                                                <div class="col-md-5 mb-3"><label class="form-label">Phone *</label><input type="text" name="phone[]" class="form-control <?php echo $index == 0 ? 'readonly-field' : ''; ?>" value="<?php echo htmlspecialchars($g['phone']); ?>" <?php echo $index == 0 ? 'readonly' : 'required'; ?>></div>
                                                <div class="col-md-4 mb-3"><label class="form-label">Email</label><input type="email" name="email[]" class="form-control <?php echo $index == 0 ? 'readonly-field' : ''; ?>" value="<?php echo htmlspecialchars($g['email']); ?>" <?php echo $index == 0 ? 'readonly' : ''; ?>></div>
                                                <div class="col-md-4 mb-3"><label class="form-label">Designation</label><input type="text" name="designation[]" class="form-control <?php echo $index == 0 ? 'readonly-field' : ''; ?>" value="<?php echo htmlspecialchars($g['designation']); ?>" <?php echo $index == 0 ? 'readonly' : ''; ?>></div>
                                                <div class="col-md-4 mb-3"><label class="form-label">Address *</label><input type="text" name="address[]" class="form-control <?php echo $index == 0 ? 'readonly-field' : ''; ?>" value="<?php echo htmlspecialchars($g['address'] ?? ''); ?>" <?php echo $index == 0 ? 'readonly' : 'required'; ?>></div>
                                                <div class="col-md-4 mb-3"><label class="form-label">NID/Office ID</label><input type="text" name="id_proof[]" class="form-control <?php echo $index == 0 ? 'readonly-field' : ''; ?>" value="<?php echo htmlspecialchars($g['id_proof']); ?>" <?php echo $index == 0 ? 'readonly' : ''; ?>></div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    ...
                                    <div class="guest-card" id="row_0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 mb-3"><label class="form-label">Name *</label><input type="text" name="guest_name[]" class="form-control readonly-field" value="<?php echo htmlspecialchars($user_data['full_name'] ?? ''); ?>" readonly></div>
                                            <div class="col-md-5 mb-3"><label class="form-label">Phone *</label><input type="text" name="phone[]" class="form-control readonly-field" value="<?php echo htmlspecialchars($user_data['phone'] ?? ''); ?>" readonly></div>
                                            <div class="col-md-4 mb-3"><label class="form-label">Email</label><input type="email" name="email[]" class="form-control readonly-field" value="<?php echo htmlspecialchars($user_data['email'] ?? ''); ?>" readonly></div>
                                            <div class="col-md-4 mb-3"><label class="form-label">Designation</label><input type="text" name="designation[]" class="form-control readonly-field" value="<?php echo htmlspecialchars($user_data['designation'] ?? ''); ?>" readonly></div>
                                            <div class="col-md-4 mb-3"><label class="form-label">Address *</label><input type="text" name="address[]" class="form-control readonly-field" value="<?php echo htmlspecialchars($user_data['address'] ?? ''); ?>" readonly required></div>
                                            <div class="col-md-4 mb-3"><label class="form-label">NID/Office ID</label><input type="text" name="id_proof[]" class="form-control readonly-field" value="<?php echo htmlspecialchars($user_data['id_proof'] ?? ''); ?>" readonly></div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="row g-2 mt-3">
                                <div class="col-md-6">
                                  <button type="submit" name="save_draft" class="btn btn-secondary w-100 py-3 fw-bold">
                                    <i class="fas fa-save me-2"></i> <?php echo $edit_id > 0 ? "UPDATE DRAFT" : "SAVE DRAFT"; ?>
                                  </button>
                                </div>
                                <div class="col-md-6">
                                  <button type="submit" id="submitBtn" name="submit_request" class="btn btn-primary w-100 py-3 fw-bold">
...
function addGuest() {
    ...
    let html = `
      <div class="guest-card" id="${id}">
        ...
        <div class="row">
          <div class="col-md-2 mb-3"><label class="form-label">Title *</label><select name="guest_title[]" class="form-select" required><option value="" disabled selected>-- Title --</option><option value="Mr.">Mr.</option><option value="Mrs.">Mrs.</option><option value="Ms.">Ms.</option></select></div>
          <div class="col-md-5 mb-3"><label class="form-label">Name *</label><input type="text" name="guest_name[]" class="form-control" required></div>
          <div class="col-md-5 mb-3"><label class="form-label">Phone *</label><input type="text" name="phone[]" class="form-control" required></div>
          <div class="col-md-4 mb-3"><label class="form-label">Email</label><input type="email" name="email[]" class="form-control" required></div>
          <div class="col-md-4 mb-3"><label class="form-label">Designation</label><input type="text" name="designation[]" class="form-control"></div>
          <div class="col-md-4 mb-3"><label class="form-label">Address *</label><input type="text" name="address[]" class="form-control" required></div>
          <div class="col-md-4 mb-3"><label class="form-label">NID/Office ID</label><input type="text" name="id_proof[]" class="form-control" required></div>
        </div>
      </div>`;
