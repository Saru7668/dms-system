...
if (isset($_POST['cancel_booking_submit'])) {
    ...
    if (empty($cancel_reason) || strlen($cancel_reason) < 10) {
        header("Location: checkout_list.php?error=reason_required"); exit;
    }
    ...
    try {
        ...
        if ($res && mysqli_num_rows($res) == 1) {
            ...
            $body = "
                ...
                <div style='background-color:#f8f9fa; border-left:4px solid #dc3545; padding:15px; margin:20px 0;'>
                    <ul style='list-style:none; padding:0; margin:0;'>
                        <li style='margin-bottom:8px;'><strong>Room:</strong> {$bk['room_no']} ({$bk['room_type']})</li>
            ...
            if (!empty($bk['guest_email'])) {
                sendBeautifulEmail($bk['guest_email'], "Booking Cancelled - Room {$bk['room_no']}", "Booking Cancelled", $req_ref_id, $body);
            }
            ...
            header("Location: checkout_list.php?cancel_success=1"); exit;
        }
    } catch (Exception $e) {
...
if (isset($_GET['checkout_room'])) {
    ...
    try {
        ...
        if ($res && mysqli_num_rows($res) > 0) {
            ...
            header("Location: checkout_list.php?checkout_success=1"); exit;
        }
    } catch (Exception $e) {
        mysqli_rollback($conn);
    }
...
<head>
    ...
    <style>
        ...
        .sidebar { background: #1a2a3a; color: white; min-height: 100vh; padding: 20px; position: fixed; width: 250px; z-index: 1000; }
                    ...
                    <tbody>
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo   "</td>
                                            <td>
                                                <span class='badge bg-primary fs-6 mb-1'>$room_no_safe</span><br><small>$room_type_safe</small>";
                                    ...
                                    echo   "</td>
                                            ...
                                            <td class='pe-3 text-center'>
                                                <div class='d-flex flex-column gap-2'>
                                                    <a href='$checkout_url' class='btn btn-warning btn-sm fw-bold shadow-sm' onclick='return confirm(\"Check-out room $room_no_safe? This will free up the room and send a confirmation email.\")'>
      ...
      <form method="post">
        ...
        <div class="modal-body bg-light">
          ...
          <div class="mb-2">
            ...
            <textarea name="cancel_reason" id="cancelReason" class="form-control border-danger" rows="3" required placeholder="Minimum 10 characters..."></textarea>
